...
import {
  LibrariesContainerComponent
} from "./modules/library/components/libraries-container/libraries-container.component";
...
} from "./modules/assignments/components/assignments-container/assignments-container.component";
import {
  BookmarksContainerComponent
} from "./modules/bookmarks/components/bookmarks-container/bookmarks-container.component";
...
const ROUTES: Routes = [
  ...
  // SEARCH
  {path: APP_ROUTES.search, loadChildren: () => import('./modules/search/search.module').then(m => m.SearchModule)},
  {path: APP_ROUTES.content, loadChildren: () => import('./modules/content/content.module').then(m => m.ContentModule)},
  ...
  {path: APP_ROUTES.bookmarks, component: BookmarksContainerComponent, title: ROUTE_TITLES[NAVIGATION_ROUTES.bookmarks]},
  {
